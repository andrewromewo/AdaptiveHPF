 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec2[0] = fTemp0 - fSlow6 * (fSlow7 * fRec2[2] + fSlow8 * fRec2[1]);
			fRec1[0] = fSlow6 * (fSlow4 * fRec2[0] + fSlow9 * fRec2[1] + fSlow4 * fRec2[2]) - fSlow5 * (fSlow10 * fRec1[2] + fSlow8 * fRec1[1]);
			fRec0[0] = fSlow5 * (fSlow4 * fRec1[0] + fSlow9 * fRec1[1] + fSlow4 * fRec1[2]) - fSlow2 * (fSlow11 * fRec0[2] + fSlow8 * fRec0[1]);
			output0[i0] = FAUSTFLOAT(fSlow2 * (fSlow4 * fRec0[0] + fSlow9 * fRec0[1] + fSlow4 * fRec0[2]));
			fRec2[2] = fRec2[1];
			fRec2[1] = fRec2[0];
			fRec1[2] = fRec1[1];
			fRec1[1] = fRec1[0];
